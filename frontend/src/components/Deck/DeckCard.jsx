...
import {
  ...
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuSeparator, // ĐÃ THÊM IMPORT NÀY
  DropdownMenuTrigger,
    ...
    <TooltipContent side="top" align="start">
      {deck.title}
        ...
        <div className="flex items-center gap-4 text-xs text-zinc-500 font-medium">
          <span className="flex items-center gap-1.5"><FiBookOpen className="size-3.5"/> {deck.cardsCount || deck.totalCards} thẻ</span>
          <span>•</span>
