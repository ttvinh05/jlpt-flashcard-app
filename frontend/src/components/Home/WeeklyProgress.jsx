    ...
    <div className="bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col justify-center items-center text-center gap-4 hover:bg-white/10 transition-all group">
      <div className="relative w-32 h-32 flex items-center justify-center"> 
        ...
        <div className="absolute flex flex-col items-center">
          <span className="text-2xl font-bold text-zinc-50 group-hover:text-blue-400 transition-colors">{percentage}%</span>
        </div>
      </div>
      
      <div>
        <p className="font-semibold text-zinc-100">Tiến độ tuần</p>
        <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-widest font-medium">Mục tiêu: 500 từ</p>
      </div>
    </div>
  );
};
