    ...
    <main className="flex-1 flex flex-col h-screen overflow-hidden text-zinc-50 font-sans relative">
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
        <div className="max-w-6xl mx-auto space-y-10">
          <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              ...
              <p className="text-zinc-400">
                Quản lý và theo dõi tiến độ các bộ từ vựng JLPT.
              </p>
            </div>
          ...
          <section
            className="relative w-full rounded-3xl border border-white/10 bg-white/5 p-8 md:p-10 overflow-hidden shadow-2xl shadow-black/50 group cursor-pointer hover:border-white/20 transition-all"
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="flex-1 space-y-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold mb-2">
                    N2基礎 - Unit 2 動詞A 161~220
                  </h2>
                  <p className="text-zinc-400">
                    Bạn đã hoàn thành 21/60 thẻ. Đang có chuỗi học rất tốt, tiếp
                    tục nào!
                  </p>
                </div>
              ...
              <Button size="lg" className="h-14 rounded-2xl font-bold shrink-0">
                Học tiếp ngay
              </Button>
            </div>
          </section>
          ...
          <section>
            ...
            {deckDataFiltered.length > 0 ? (
              ...
              <button className="w-full flex flex-col items-center justify-center py-20 px-4 text-center bg-transparent border-2 border-dashed border-white/10 rounded-3xl group hover:border-white/30 hover:bg-white/5 transition-all outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
                ...
                <p className="text-zinc-500 text-sm max-w-sm group-hover:text-zinc-400 transition-colors">
                  Bạn chưa tạo học phần nào trong mục{" "}
                  <span className="text-zinc-300 font-semibold">
                    {isTabActive}
                  </span>
                  . Nhấn vào đây để tạo mới nhé!
                </p>
              </button>
            )}
          </section>
